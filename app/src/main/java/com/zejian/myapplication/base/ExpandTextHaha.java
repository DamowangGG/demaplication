...
public class ExpandTextHaha extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final String DEFAULT_CLOSE_END_TEXT = "展开";
    ...
    public ExpandTextHaha(Context context) {
        this(context, null);
    }

    public ExpandTextHaha(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExpandTextHaha(Context context, AttributeSet attrs, int defStyleAttr) {
