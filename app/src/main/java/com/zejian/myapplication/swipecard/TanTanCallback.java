...
import static com.zejian.myapplication.swipecard.CardConfig.MAX_SHOW_COUNT;
import static com.zejian.myapplication.swipecard.CardConfig.SCALE_GAP;
import static com.zejian.myapplication.swipecard.CardConfig.TRANS_Y_GAP;
...
/*        if (isLeftSwipe){
        ...
        if (viewHolder instanceof BaseViewHolder) {
            ...
            holder.getView(R.id.iv_love).setAlpha(0);
            holder.getView(R.id.iv_del).setAlpha(0);
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (level > 0) {
                ...
                if (viewHolder instanceof BaseViewHolder) {
                    ...
                    if (dX > 0) {
                        //露出左边，比心
                        holder.getView(R.id.iv_love).setAlpha(xFraction);
                    } else if (dX<0){
                        //露出右边，滚犊子
                        holder.getView(R.id.iv_del).setAlpha(-xFraction);
                    }else {
                        holder.getView(R.id.iv_love).setAlpha(0);
                        holder.getView(R.id.iv_del).setAlpha(0);
                    }
