...
class UserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val desiredToolbarHeight = motionLayout.minHeight
        ...
        ViewCompat.setOnApplyWindowInsetsListener(motionLayout) { _, insets: WindowInsetsCompat ->
            // resize the motionLayout in collapsed state to add the needed inset height
            val insetTopHeight = insets.systemWindowInsetTop
            motionLayout.minimumHeight = desiredToolbarHeight + insetTopHeight
