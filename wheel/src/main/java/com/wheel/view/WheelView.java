...
import com.wheel.R;
import com.wheel.adapter.WheelAdapter;
import com.wheel.interfaces.IPickerViewData;
import com.wheel.listener.LoopViewGestureListener;
import com.wheel.listener.OnItemSelectedListener;
import com.wheel.timer.InertiaTimerTask;
import com.wheel.timer.PickerMsgHandler;
import com.wheel.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    private final float DEFAULT_TEXT_TARGET_SKEWX = 0.6f;
    ...
    private void initLoopView(Context context) {
        ...
        handler = new PickerMsgHandler(this);
