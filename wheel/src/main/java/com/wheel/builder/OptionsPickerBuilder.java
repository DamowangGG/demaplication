...
public class OptionsPickerBuilder {
    ...
    //Required
    public OptionsPickerBuilder(Context context,boolean small, OnOptionsSelectListener listener) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_OPTIONS_SMALL);
        mPickerOptions.context = context;
        mPickerOptions.optionsSelectListener = listener;
    }
