...
public final class SmoothScrollTimerTask extends TimerTask {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            wheelView.getHandler().sendEmptyMessage(PickerMsgHandler.WHAT_ITEM_SELECTED);
        } else {
            ...
            wheelView.getHandler().sendEmptyMessage(PickerMsgHandler.WHAT_INVALIDATE_LOOP_VIEW);
