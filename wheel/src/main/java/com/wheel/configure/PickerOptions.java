...
public class PickerOptions {
    ...
    //常量
    private static final int PICKER_VIEW_BTN_COLOR_NORMAL = 0xFF3B3B3B;
    private static final int PICKER_VIEW_BG_COLOR_TITLE = 0xFFf5f5f5;
    private static final int PICKER_VIEW_COLOR_TITLE = 0xFF3B3B3B;
    private static final int PICKER_VIEW_BG_COLOR_DEFAULT = 0x00000000;

    public static final int TYPE_PICKER_OPTIONS = 1;
    public static final int TYPE_PICKER_TIME = 2;
    public static final int TYPE_PICKER_OPTIONS_SMALL = 3;
    ...
    public int textColorCancel = Color.TRANSPARENT;//取消按钮颜色
    ...
    public float lineSpacingMultiplier = 1.7f; // 条目间距倍数 默认1.6
